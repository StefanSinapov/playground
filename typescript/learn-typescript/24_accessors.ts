...
// Case:2 -- For any case if we want to apply access modifier other then public on getter
// and setter then we must apply same access modifier on both getter and setter
class Human {
    private _fullName: string;
